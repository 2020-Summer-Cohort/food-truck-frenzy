...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Vendor vendor2 = new Vendor("Broke Johnny Food Truck", "Breakfast and Brunch", "http://www.brokejohnnytruck.com/#menu-1-section", "../../images/BrokeJohnny.png", event2);
        ...
        Vendor vendor3 = new Vendor("Exotic Latino Grill", "Nuevo Latino", " https://www.zmenu.com/exotic-latino-grill-columbus-2-online-menu/", "../../images/exotic-latino-grill.png", event3);
        ...
        Vendor vendor4 = new Vendor("Cousin's Maine Lobster", "Seafood", "https://www.cousinsmainelobster.com/menu/?location=columbus_oh&type=truck/", "../../images/cousin-logo.png", event4);
        ...
        Vendor vendor5 = new Vendor("Ray Ray's Hog Pit", "BBQ", "https://www.rayrayshogpit.com/", "../../images/ray-rays.png", event5);
        ...
        Vendor vendor6 = new Vendor("Schmidt's", "German", "https://www.schmidthaus.com/sausage-truck-menu/", "../../images/schmidts.png", event6);
        ...
        Vendor vendor7 = new Vendor("Dos Hermanos", "Mexican", "https://doshermanoscolumbus.com/menu/", "../../images/dos.png", event6);
        ...
        Vendor vendor8 = new Vendor("Kabob Time", "Mediterranean", "http://places.singleplatform.com/kabob-time/menu?ref=google", "../../images/kabob.png", event5);
        ...
        Vendor vendor9 = new Vendor("The Angry Wiener", "Hot Dogs", "https://www.theangrywiener.com/menu", "../../images/wiener.png", event4);
